...
<html>
<head>
    <title> Appello PersonaleTA </title>
    ...
    <link type="text/css" rel="stylesheet" href="styles/appellipersonaleTAstyle.css">
...
<div class="container">
    ...
    <main>
        <form id="add-exam-form">
            ...
            <button type="submit">Aggiungi esame</button>
        </form>
    </main>
</div>
<br>
...
<!--Ipotetica funzione per l'invio-->
<script>
