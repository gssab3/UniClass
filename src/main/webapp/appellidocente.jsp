...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="styles/appellistyle.css">
...
<br>
<div class="header1">
    <h1>Appelli ed Iscritti</h1>
</div>
<br>
<br>
<main class="appeals-container">
    <div class="appeal-card">
        <h2 class="appeal-title">Ingegneria del Software</h2>
        <p class="appeal-description"> I Appello - 10/01/2025</p>
        <h3>Iscritti</h3>
        <ul class="subscribers-list">
            <li class="subscriber">John Doe</li>
            <li class="subscriber">Jane Smith</li>
            <li class="subscriber">Mike Johnson</li>
        </ul>
    </div>

    <div class="appeal-card">
        <h2 class="appeal-title">Programmazione Avanzata</h2>
        <p class="appeal-description">II Appello - 25/01/2025 </p>
        <h3>Iscritti</h3>
        <ul class="subscribers-list">
            <li class="subscriber">Emily Brown</li>
            <li class="subscriber">David Lee</li>
            <li class="subscriber">Sarah Wilson</li>
            <li class="subscriber">Tom Harris</li>
        </ul>
    </div>
